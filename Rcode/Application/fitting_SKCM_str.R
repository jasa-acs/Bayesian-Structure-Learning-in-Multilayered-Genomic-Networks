...
load("../data/TCGA_SKCM_CNA_Methylation_mRNA_RPPA.rda")
...
load(paste("../appl_results/SKCM_fit_pp",pp,".rda",sep=""))
p = addr[q]
...
save(Y,lambda,delta,a,b,fit,file=paste("../appl_results/SKCM_fit_str_pp",pp,".rda",sep=""))
