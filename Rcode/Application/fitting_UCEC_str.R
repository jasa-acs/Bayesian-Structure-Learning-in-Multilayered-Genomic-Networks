...
load("../data/TCGA_UCEC_CNA_Methylation_mRNA_RPPA.rda")
...
load(paste("../appl_results/UCEC_fit_pp",pp,".rda",sep=""))
p = addr[q]
...
save(Y,lambda,delta,a,b,fit,file=paste("../appl_results/UCEC_fit_str_pp",pp,".rda",sep=""))
